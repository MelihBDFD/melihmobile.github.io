...
const initializeDOMElements = () => {
  ...
  newListInput.placeholder = 'Yeni liste';
  newListInput.autocomplete = 'off';
  newListSubmit.type = 'submit';
  newListSubmit.value = '+ Ekle';
  ...
  newTodoInput.placeholder = '+ Görev ekle';
  ...
  emptyStateText.textContent = 'Aklından hangi görevler geçiyor?';
  ...
  sortTitle.textContent = 'Şuna göre sırala';
  sortList.insertAdjacentHTML(
    ...
    <li class="sort-type" id="sortByName">
      <button class='sort-type-btn'>
        ${sortNameSVG}
        <span class="text">Alfabetik</span>
      </button>
    </li>
    <li class="sort-type" id="sortByCompleted">
      <button class='sort-type-btn'>
        ${sortCompletedSVG}
        <span class="text">Tamamlanan</span>
      </button>
    </li>
    <li class="sort-type" id="sortByMyDay">
      <button class='sort-type-btn'>
        ${daySVG}
        <span class="text">Bugünüme Eklendi</span>
      </button>
    </li>
    <li class="sort-type" id="sortByBookmarked">
      <button class='sort-type-btn'>
        ${importantSVG}
        <span class="text">Yer İmlerine Eklendi</span>
      </button>
    </li>
  ...
  const setSortIndicator = (type, direction, isAnimated) => {
    ...
    sortIndicatorText.textContent = `${type} göre sıralandı`;
  ...
  modalTitle.innerHTML = 'Emin misiniz?';
  const modalText = createElement('p');
  modalText.innerHTML = 'Bu öğeyi silmek istediğinizden emin misiniz?';
  ...
  const noteIndicatorFn = () => {
    ...
    noteIndicatorLabel.innerHTML = 'Not';
  ...
  const importantIndicatorFn = () => {
    ...
    importantIndicator.querySelector('svg').dataset.tooltip = 'Yer imlerine eklenen görev';
  ...
  const myDayIndicatorFn = () => {
    ...
    myDayIndicator.querySelector('svg').dataset.tooltip = 'Bugünüme eklenen görev';
